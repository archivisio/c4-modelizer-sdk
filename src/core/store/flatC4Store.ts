        ...
        updateContainer: (containerId, data) =>
          set((state) => {
            ...
            return {
              model: {
                ...state.model,
                systems: propagateUpdate(state.model.systems, containerId, commonChanges),
          ...
          set((state) => {
            ...
            return {
              model: {
                ...
                systems: state.model.systems.map(s => ({
                  ...s,
                  connections: s.connections.filter(conn => conn.targetId !== containerId)
                })),
                containers: updatedContainerConnections.filter(c => c.id !== containerId),
                components: state.model.components.filter(c => c.containerId !== containerId),
                codeElements: state.model.codeElements.filter(c => c.containerId !== containerId),
              },
            };
          }),
          ...
          set((state) => {
            ...
            return {
              model: {
                ...
                systems: state.model.systems.map(s => ({
                  ...s,
                  connections: s.connections.filter(conn => conn.targetId !== componentId)
                })),
                containers: state.model.containers.map(c => ({
                  ...c,
                  connections: c.connections.filter(conn => conn.targetId !== componentId)
                ...
                codeElements: state.model.codeElements.filter(c => c.componentId !== componentId),
              },
            };
          }),
          ...
          set((state) => {
            ...
            return {
              model: {
                ...
                systems: state.model.systems.map(s => ({
                  ...s,
                  connections: s.connections.filter(conn => conn.targetId !== codeElementId)
                })),
                containers: state.model.containers.map(c => ({
                  ...c,
                  connections: c.connections.filter(conn => conn.targetId !== codeElementId)
